...
make_refresh_menu('mainpage', 'hat_ipmi', CProfile::get('web.dashboard.rf_rate.hat_ipmi',60), null, $menu, $submenu);
make_refresh_menu('mainpage', 'hat_vsphere', CProfile::get('web.dashboard.rf_rate.hat_vsphere',60), null, $menu, $submenu);
make_refresh_menu('mainpage', 'hat_aws', CProfile::get('web.dashboard.rf_rate.hat_aws',60), null, $menu, $submenu);
...
$refresh_tab = array(
	...
	array('id' => 'hat_ipmi','frequency'  => CProfile::get('web.dashboard.rf_rate.hat_ipmi',60)),
	array('id' => 'hat_vsphere','frequency'  => CProfile::get('web.dashboard.rf_rate.hat_vsphere',60)),
	array('id' => 'hat_aws','frequency'  => CProfile::get('web.dashboard.rf_rate.hat_aws',60))
);
...
if(USER_TYPE_SUPER_ADMIN == $USER_DETAILS['type']){
	...
	if(!empty($ipmistat_summary)){
		$ipmistat = new CUIWidget('hat_ipmi', $ipmistat_summary ,CProfile::get('web.dashboard.hats.hat_ipmi.state',1));
...
if(USER_TYPE_SUPER_ADMIN == $USER_DETAILS['type']){
	...
	if(!empty($vspherestat_summary)){
		$vspherestat = new CUIWidget('hat_vsphere', $vspherestat_summary ,CProfile::get('web.dashboard.hats.hat_vsphere.state',1));
...
if(USER_TYPE_SUPER_ADMIN == $USER_DETAILS['type']){
	...
	if(!empty($awsstat_summary)){
		$awsstat = new CUIWidget('hat_aws', $awsstat_summary, CProfile::get('web.dashboard.hats.hat_aws.state', 1));
